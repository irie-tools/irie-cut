...
- **Pam Album imports** — `iriePromo: 2` YouTube Album Release folders open in an import review: track/audio/video/lyrics preflight, missing-asset repair, music-video formula packs, visual and caption choices, export target checklist, honest enhance/prep intent, then one long 16:9 album timeline with track audio, existing videos, fallback visuals, lyrics captions, and chapter markers.
